module.exports = function(grunt){
	...
	/*
		...
		2. concatenate all of your javascript files (ignoring vendor.js and main.min.js) into main.min.js
		3. minify main.min.js to main.min.js
		4. delete the old build directory
		5. copy over everything to the build directory
			a) Except:
				css (except main.css)
				...
				.gitignore, 
				.gitattributes, 
		6. change index.php to use 'production' constant (inside the build directory)
	*/
