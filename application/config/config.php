...
|
*/
$config['log_threshold'] = (ENVIRONMENT == 'development') ? 3 : 0;
...
|
*/
$config['encryption_key'] = '1ndhc7)(&%#GCN,.&@JD41c89035fc34';
...
*/
$config['csrf_protection'] = TRUE; //SWIITCH BACK ON WHEN YOU ARE READY
